...
class Classification extends BaseModel
{
    ...
    const ATTR_TABLE = 'classifications';
    ...
    /**
     * Get the classification param associated with the parameter.
     */
    public function classificationParameter()

    {
        return $this->belongsTo(ClassificationParameter::class, ClassificationParameter::ATTR_INT_CLASSIFICATION)->select(
