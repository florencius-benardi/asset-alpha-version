...
class HandOverLineDetail extends BaseModel
{
    use HasFactory, SoftDeletes;

    const ATTR_TABLE = 'handover_line_details';

    const ATTR_INT_HANDOVER_HEADER = 'handover_header_id';
    const ATTR_INT_HANDOVER_LINE_NO = 'handover_line_no';
    ...
    protected $fillable = [
        ...
        self::ATTR_INT_HANDOVER_LINE_NO,
